...
@Component({
  ...
  standalone: true,
  imports: [MontantTotalInvestiComponent, RevenusmensuelsComponent, SectoralRepartitionComponent, RepartitionGeographiqueComponent, ListeInvestissementsComponent, PortfolioSummaryComponent ],

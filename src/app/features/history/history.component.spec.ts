...
describe('HistoryComponent', () => {
  ...
  const mockHistories: History[] = [
    { investmentId: 1, modificationDate: new Date('2023-10-01'), status: 'SUCCESS' },
    { investmentId: 2, modificationDate: new Date('2023-10-02'), status: 'FAILED' },
    { investmentId: 3, modificationDate: new Date('2023-10-03'), status: 'PENDING' },
  ];
